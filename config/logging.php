...
return [
    ...
    'channels' => [
        ...
        'stderr' => ['driver' => 'monolog', 'level' => env('LOG_LEVEL', 'debug'), 'handler' => StreamHandler::class, 'formatter' => env('LOG_STDERR_FORMATTER'), 'with' => ['stream' => 'php://stderr'], 'replace_placeholders' => true],
        'cyberguard' => ['driver' => 'daily', 'path' => storage_path('logs/cyberguard.log'), 'level' => 'info', 'days' => 30],
        'auth' => ['driver' => 'daily', 'path' => storage_path('logs/auth.log'), 'level' => 'debug', 'days' => 30],
    ],
];
